...
class CreditSerializerTests(TestCase):
    def test_credit_serializer_representation(self):
        ...
        collaborator = Collaborator.objects.create(
            name="Test Writer", twitter="bbncreative"
        )
        ...
        self.assertEquals(representation["collaborator"]["name"], "Test Writer")
        self.assertEquals(representation["collaborator"]["twitter"], "bbncreative")
    ...
    def test_customised_collaborator_serializer_representation(self):
        ...
        credit = Credit.objects.create(
            collaborator=collaborator, project=project, action="Tester"
        )
