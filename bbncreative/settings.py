...
DATABASES = {
    'default': {
        ...
        'NAME': secrets.POST_DB.get("NAME"),
        'USER': secrets.POST_DB.get("USER"),
        'PASSWORD': secrets.POST_DB.get("PASSWORD"),
        'HOST': secrets.POST_DB.get("HOST"),
        'PORT': secrets.POST_DB.get("PORT"),
    }
}
